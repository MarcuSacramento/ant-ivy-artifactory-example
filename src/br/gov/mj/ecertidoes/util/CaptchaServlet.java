...
public class CaptchaServlet extends javax.servlet.http.HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			request.getSession().setAttribute("id", jsid);
			/* Gera a imagem */

			BufferedImage challenge = Captcha.getInstance().getService()
					.getImageChallengeForID(jsid);
		...
		/*
		 * Modifica os cabeçalhos http para que a imagem não seja armazenada em
		 * cache
		 */
